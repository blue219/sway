...
- When a round starts, its five selected quiz illustrations, hand guide, and result tree begin loading and decoding in the background. The image references are released when the round resets; images outside the selected quiz are not preloaded.
